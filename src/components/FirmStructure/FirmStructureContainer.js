...
import {builtInSort, ownSelectionSort} from './common/sortFunctions'
import FirmStructure from './index'

const cx = classNames.bind(s)

class FirmStructureContainer extends Component {
  state = {
    isModalShow: false,
...
//     const showingFirmStructSection = ownSelectionSort(oldShowingFirmStructSection, sortDirection, columnName)
    ...
    return <FirmStructure isCategoryDisabled={isCategoryDisabled}
...
export default FirmStructureContainer
